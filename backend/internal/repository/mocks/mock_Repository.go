...
// ActivateBranchTx provides a mock function for the type MockRepository
func (_mock *MockRepository) ActivateBranchTx(ctx context.Context, tx *sql.Tx, messageID string) error {
	ret := _mock.Called(ctx, tx, messageID)

	if len(ret) == 0 {
		panic("no return value specified for ActivateBranchTx")
	}
...
// MockRepository_ActivateBranchTx_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ActivateBranchTx'
type MockRepository_ActivateBranchTx_Call struct {
	*mock.Call
}

// ActivateBranchTx is a helper method to define mock.On call
//   - ctx context.Context
//   - tx *sql.Tx
//   - messageID string
func (_e *MockRepository_Expecter) ActivateBranchTx(ctx interface{}, tx interface{}, messageID interface{}) *MockRepository_ActivateBranchTx_Call {
	return &MockRepository_ActivateBranchTx_Call{Call: _e.mock.On("ActivateBranchTx", ctx, tx, messageID)}
}

func (_c *MockRepository_ActivateBranchTx_Call) Run(run func(ctx context.Context, tx *sql.Tx, messageID string)) *MockRepository_ActivateBranchTx_Call {
...
func (_c *MockRepository_ActivateBranchTx_Call) Return(err error) *MockRepository_ActivateBranchTx_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockRepository_ActivateBranchTx_Call) RunAndReturn(run func(ctx context.Context, tx *sql.Tx, messageID string) error) *MockRepository_ActivateBranchTx_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetMessagesByChatID provides a mock function for the type MockRepository
func (_mock *MockRepository) GetMessagesByChatID(ctx context.Context, chatID string) ([]model.Message, error) {
	ret := _mock.Called(ctx, chatID)
...
// MockRepository_GetMessagesByChatID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetMessagesByChatID'
type MockRepository_GetMessagesByChatID_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - chatID string
func (_e *MockRepository_Expecter) GetMessagesByChatID(ctx interface{}, chatID interface{}) *MockRepository_GetMessagesByChatID_Call {
	return &MockRepository_GetMessagesByChatID_Call{Call: _e.mock.On("GetMessagesByChatID", ctx, chatID)}
}

func (_c *MockRepository_GetMessagesByChatID_Call) Run(run func(ctx context.Context, chatID string)) *MockRepository_GetMessagesByChatID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_GetMessagesByChatID_Call) Return(messages []model.Message, err error) *MockRepository_GetMessagesByChatID_Call {
	_c.Call.Return(messages, err)
	return _c
}

func (_c *MockRepository_GetMessagesByChatID_Call) RunAndReturn(run func(ctx context.Context, chatID string) ([]model.Message, error)) *MockRepository_GetMessagesByChatID_Call {
	_c.Call.Return(run)
	return _c
}
